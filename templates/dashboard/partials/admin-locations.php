		...
		<?php foreach ( $countries as $country ) : ?>
			<div class="dak-country-row" data-country-row>
				<div class="dak-country-row-header">
					<input type="text" class="dak-country-name" placeholder="<?php esc_attr_e( 'Country name', 'doctor-ak-portal' ); ?>" value="<?php echo esc_attr( $country['name'] ); ?>">
				...
				<div class="dak-cities-rows" data-cities-rows>
					<?php foreach ( $country['cities'] as $city ) : ?>
						<div class="dak-city-row" data-city-row>
							<input type="text" class="dak-city-name" placeholder="<?php esc_attr_e( 'City name', 'doctor-ak-portal' ); ?>" value="<?php echo esc_attr( $city['name'] ); ?>">

							<div class="dak-areas-rows" data-areas-rows>
								<?php foreach ( $city['areas'] as $area ) : ?>
									<span class="dak-area-chip" data-area-row>
										<input type="text" class="dak-area-name" placeholder="<?php esc_attr_e( 'Area', 'doctor-ak-portal' ); ?>" value="<?php echo esc_attr( $area['name'] ); ?>">
