...
?>
<button type="button" class="dak-theme-toggle" id="dak-theme-toggle" title="<?php esc_attr_e( 'Toggle dark mode', 'doctor-ak-portal' ); ?>" aria-label="<?php esc_attr_e( 'Toggle dark mode', 'doctor-ak-portal' ); ?>">
