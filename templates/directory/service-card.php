 ...
 *
 * @var int    $id          Service's catalog ID.
 * @var string $name        Service name.
 * @var string $description Full description (excerpted below).
 * @var string $price_label Formatted price, e.g. "PKR 5,000" or "Free".
 * @var string $image_url   Service image URL, or '' if none uploaded.
 * @var array  $clinic_locations Clinics this service is offered at, see Service_Catalog.
 * @var array  $doctors     Doctors who provide this service, see Service_Catalog.
